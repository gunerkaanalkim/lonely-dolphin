...
class MinimumCalculationStrategyTest {
    @InjectMocks
    MinimumCalculationStrategy minimumCalculationStrategy;
    ...
    void calculate() {
        ...
        Map<Metric, Double> calculate = minimumCalculationStrategy.calculate(metricListMap);

        assertEquals(10.0, calculate.get(metric));
    }
