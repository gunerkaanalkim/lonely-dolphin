...
class AverageCalculationStrategyTest {
    @InjectMocks
    AverageCalculationStrategy averageCalculationStrategy;
    ...
    void calculate() {
        ...
        Map<Metric, Double> calculate = averageCalculationStrategy.calculate(metricListMap);

        assertEquals(10.5, calculate.get(metric));
    }
